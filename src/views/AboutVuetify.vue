<template>
     ...
     max-width="700"
     max-height="800"
     style="background:linear-gradient(to bottom right, #33ccff, #ff99cc)"
  >
 <v-container fluid>
     ...
     * {
     ...
     body {
   background-image: url('https://i.pinimg.com/originals/34/ab/da/34abda00656d36ce524937e47749a300.jpg');
